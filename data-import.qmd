...
A função `tibble()` funciona por coluna:
...
A função `tribble()` é customizada para entrada de dados no código: os cabeçalhos das colunas começam com `~` e as entradas são separadas por vírgulas.
