...
Todos os comandos em R onde você cria objetos, **comandos de atribuição**, têm a mesma forma:
...
Isso ilustra o contrato implícito entre você e o R: o R fará os cálculos chatos para você, mas em troca, você deve escrever suas instruções de forma precisa.
...
Vamos tentar usar `seq()`, que faz **seq**uências regulares de números, e enquanto fazemos isso, vamos aprender mais sobre os recursos do RStudio.
