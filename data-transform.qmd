...
Quando montamos um gráfico da habilidade dos rebatedores (medidas pela média de acerto, `performance`) contra o número de oportunidades de acertar a bola (medidas pelo número de vezes ao bastão, `n`), é possível ver dois padrões:
