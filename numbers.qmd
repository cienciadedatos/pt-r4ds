...
Uma alternativa é usar a mediana, com `median()`, que encontra o valor que se encontra no "meio" do vetor, por exemplo: 50% dos valores estão acima e 50% estão abaixo.
