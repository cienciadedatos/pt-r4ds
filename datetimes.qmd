...
Para criar uma data-hora, adicione um *underscore* (`_`) e uma ou mais de "h", "m" e "s" ao nome da função de análise (*parsing*):
...
[^datetimes-3]: Você pode se perguntar o que significa UTC.
    É um meio-termo entre o inglês "Coordinated Universal Time" e o francês "Temps Universel Coordonné".
...
Observe que quando você usa datas-hora em um contexto numérico (como em um histograma), 1 significa 1 segundo, então uma largura de intervalo de classe (*bin*) de 86400 significa um dia.
...
#|   e atraso médio (4-16). Há pouca tendência evidente, apenas uma
