...
Isso é o que temos nos dados `flights`:
...
4.  Como o tempo médio de atraso muda ao longo do dia?
  Você deve usar `dep_time` ou `sched_dep_time`?
  Por quê?
...
E veja a lista completa de todos os nomes de fusos horários com `OlsonNames()`:
...
-   Manter o instante no tempo o mesmo e alterar como ele é exibido.
  Use isso quando o instante estiver correto, mas você quiser uma exibição mais natural.
    ...
    -   Alterar o instante subjacente no tempo.
      Use isso quando você tiver um instante que foi rotulado com o fuso horário incorreto e precisar corrigi-lo.
